 ...
 */
class Doctrine2Provider implements \Oss2\Auth\UserProviderInterface
{
    /**
    ...
    public function retrieveByCredentials( array $credentials )
    {
        ...
        $qb = $this->d2repository->createQueryBuilder( 'oss2-auth-provider-doctrine2' )
            ->select( 'u' )
            ->setMaxResults( 1 );
